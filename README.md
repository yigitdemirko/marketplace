...
Marketplace; alıcı ve satıcı akışları, gerçek zamanlı arama, Kafka tabanlı olay-güdümlü iletişim ve Iyzico ödeme entegrasyonu içeren tam yığın bir e-ticaret platformudur.
...
graph LR
    ...
    class US,CS,SS,OS,PM,NS,FI,IV svc
    class GW gw
    class FE fe
...
- **Apache Kafka** — olay-güdümlü iletişim
...
graph LR
    ...
    FE2 -->|HTTPS| GW2
    GW2 --> US2 & CS2 & SS2 & OS2 & PM2 & FI2 & IV2 & NS2
    ...
    classDef fe fill:#dbeafe,stroke:#2563eb,color:#1e3a8a
    classDef ds fill:#fed7aa,stroke:#ea580c,color:#7c2d12
    class US2,CS2,SS2,OS2,PM2,NS2,FI2,IV2 svc
    class GW2 gw
    class FE2 fe
...
graph LR
    ...
    classDef svc fill:#dcfce7,stroke:#16a34a,color:#14532d
    classDef bus fill:#fce7f3,stroke:#db2777,color:#831843
    class OS4,CS4,IV4,PM4,SS4,NS4 svc
    class K4 bus
```
